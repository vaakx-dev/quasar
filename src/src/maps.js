...
(function () {
	...
	mapping.generate = function (seed) {
		...
		//genBox() # Uncomment this to debug
	...
	mapping.genTower = function () {
		...
		blocks = [
			"ExULFRUIERUIExcIExMI",
			"FBQUExgHGBUJFRAHEBMJEBUJFRgHExAHGBMJ",
		];
		towers = [
			"ERQQFxQQEREIFxEIFBcJFBEJERcKFxcKFBQBFBQw",
			"FBQDERQQFxQQEREIFxEIFBcJFBEJERcKFxcKFBQy",
			"ERQQFBcJFxQQEREIFxEIFBQDERcKFxcKFBESFBQ4",
			"ERQQFBcJFxQQEREIFxEIFBQDERcKFxcKFBESFBQ1",
		];
		forts = [
			...
			results.push(
				(function () {
					...
					for (i = m = 0; m < 6; i = ++m) {
						...
						u.pos = v2.create(thing.pos);
						u.pos[0] +=
							Math.sin((i / 3) * Math.PI) * thing.radius * 0.8;
						u.pos[1] +=
							Math.cos((i / 3) * Math.PI) * thing.radius * 0.8;
						u.side = thing.side;
						u.rot = Math.PI / 2;
			...
			if (i === 0) {
				...
				for (i = o = 0; o < 10; i = ++o) {
					...
					for (_ in ref1) {
						t = ref1[_];
						if (
							v2.distance(t.pos, a.pos) <
							t.radius + a.radius + 100
						) {
							tooClose = true;
							break;
						}
				...
				results.push(
					(function () {
						...
						for (i = o = 0; o < 6; i = ++o) {
							...
							dodad.pos[0] +=
								Math.sin((i / 3) * Math.PI) * radius * 0.8;
							dodad.pos[1] +=
								Math.cos((i / 3) * Math.PI) * radius * 0.8;
