(function () {
	...
	m4.str = function (mat) {
		return [
			Math.round((mat[0])*10000)/10000,
			Math.round((mat[1])*10000)/10000,
			Math.round((mat[2])*10000)/10000,
			Math.round((mat[3])*10000)/10000,
			"|",
			Math.round((mat[4])*10000)/10000,
			Math.round((mat[5])*10000)/10000,
			Math.round((mat[6])*10000)/10000,
			Math.round((mat[7])*10000)/10000,
			"|",
			Math.round((mat[8])*10000)/10000,
			Math.round((mat[9])*10000)/10000,
			Math.round((mat[10])*10000)/10000,
			Math.round((mat[11])*10000)/10000,
			"|",
			Math.round((mat[12])*10000)/10000,
			Math.round((mat[13])*10000)/10000,
			Math.round((mat[14])*10000)/10000,
			Math.round((mat[15])*10000)/10000,
		].join(" ");
	};
}).call(this);
